...
namespace NZWalks.API.Controllers
{
    ...
    public class RegionsController : Controller
    {
        ...
        [HttpGet]//async of bottom commented method
        ...
        [HttpPut]
        [Route("{id:guid}")]
        public async Task<IActionResult> UpdateRegionAsnyc([FromRoute] Guid id, 
            [FromBody] Models.DTO.UpdateRegionRequest updateRegionRequest)
        {
            //validate incoming request
            //if (!ValidateUpdateRegionAsnyc(updateRegionRequest))
            //{
            //    return BadRequest(ModelState);
            //}
        ...
        private bool ValidateUpdateRegionAsnyc(Models.DTO.UpdateRegionRequest updateRegionRequest)
        {
